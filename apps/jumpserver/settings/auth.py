...
AUTH_OPENID_PROVIDER_TYPE = CONFIG.AUTH_OPENID_PROVIDER_TYPE
AUTH_OPENID_ENTRA_TENANT_ID = CONFIG.AUTH_OPENID_ENTRA_TENANT_ID
AUTH_OPENID_ALLOWED_ISSUERS = CONFIG.AUTH_OPENID_ALLOWED_ISSUERS
...
AUTH_OPENID_SYNC_GROUPS = CONFIG.AUTH_OPENID_SYNC_GROUPS
...
DISABLE_LOCAL_PASSWORD_LOGIN = CONFIG.DISABLE_LOCAL_PASSWORD_LOGIN
